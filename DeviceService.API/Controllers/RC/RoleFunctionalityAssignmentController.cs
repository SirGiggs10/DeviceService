...
using Amana.Data;
using Amana.Dtos;
using Amana.Dtos.RoleFunctionality;
using Amana.Interface;
using Amana.Models;
using AutoMapper;
...
using static Amana.Helpers.Utils;
...
namespace Amana.Controllers
{
    ...
    public class RoleFunctionalityAssignmentController : ControllerBase
    {
        ...
        public RoleFunctionalityAssignmentController(DataContext dataContext, IRoleFunctionalityAssignmentRepository userManagementRepository, IMapper mapper)
        {
        ...
        public async Task<ActionResult> AssignRoleFunctionality(List<AssignRoleFunctionality> assignRoleFunctionalities)
        {
             foreach(var functionalityRole in assignRoleFunctionalities)
             {
                ...
                if (functionalityRole.Roles.Length != 0)
                {
